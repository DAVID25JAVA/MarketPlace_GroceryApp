...
function Navbar() {
  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 border-b border-b-gray-400 px-4 sm:px-6 lg:px-8">
      <div className="flex gap-1 items-center text-xl justify-center font-bold">
        <img
          ...
          alt=""
        />
        <NavLink to='/'> <p className="mt-1 text-purple-800 cursor-pointer">MarketPlace</p></NavLink>
      ...
      {/* User Profile and Buttons (Hidden on mobile) */}
      <div className="hidden md:flex gap-3">
        <div className="flex items-center gap-3 cursor-pointer">
          <img className="w-8 rounded-full" src={asstes.Profile_Photo} alt="" />
      ...
      >
        <div className="flex items-center justify-between px-5 py-1">
          <img className="w-12" src={asstes.logo} alt="" />
          <img
            className="w-10 cursor-pointer"
